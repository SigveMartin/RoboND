...
def test_code(test_case):
	...
	TF = Matrix([
		[             cos(q),            -sin(q),            0,              a],
               	[ sin(q)*cos(alpha), cos(q)*cos(alpha), -sin(alpha), -sin(alpha0)*d],
               	[ sin(q)*sin(alpha), cos(q)*sin(alpha),  cos(alpha),  cos(alpha0)*d],
               	[                   0,                   0,            0,               1]])
	return TF  
    #
    ...
    sideB = N(sqrt(pow((sqrt(WC[0]*WC[0]+WC[1]*WC[1])-0.35),2)+pow((WC[2]-0.75),2)))
    sideC = 1.25
    ...
    ## theta 2 and theta 3
    #################################### 
    #theta2 = N(pi/2 - angle_a - atan2(yB,xB))
    theta2 = pi/2 -angle_a -atan2(WC[2]-0.75,sqrt(WC[0]*WC[0]+WC[1]*WC[1])-0.35)
    print("Theta 2 is: %s"% theta2)
    # atan2(0.054,1.5) = 0.036 due to the -0.054 sag of link4 
    theta3 = pi/2. - (angle_b + 0.036)
    print("Theta 3 is: %s"% theta3)
    ...
    #print("Theta 4 is: %s"% theta4)
    #theta5 = atan2(sqrt(R3_6[0,2]*R3_6[0,2]+R3_6[2,2]*R3_6[2,2]),R3_6[1,2])
    #print("Theta 5 is: %s"% theta5)
    #theta6 = atan2(-R3_6[1,1],R3_6[1,0])
    #print("Theta 6 is: %s"% theta6)
    ## 
