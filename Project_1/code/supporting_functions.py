...
def update_rover(Rover, data):
      ...
      # The store the previous position in Rover.prev_pos
      ...
      Rover.throttle,"roll =",Rover.roll,"pitch =",Rover.pitch,'steer_angle =', Rover.steer, 'near_sample:', Rover.near_sample, 
